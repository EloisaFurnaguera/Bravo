...
def load_shows(file_user):
    ...
    for row in (open(file_user)):
        ...
        user_id, show_name, show_type,show_url, show_amount_people, show_dressing_room, show_length, show_location_preferred, time_id, show_ticket_price, show_rent = row.split(",")
