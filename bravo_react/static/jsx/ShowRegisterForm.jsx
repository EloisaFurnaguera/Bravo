    ...
    <form onSubmit= {this.handleShowRegister}>  
      ...
      <div className="form-group">
          <label>Name of Show / Group / Act</label>
            <input type="text" className="form-control" name="show_name" 
                     value={this.state.show_name} onChange={this.handleShowInput} required />         
                    </div>
      ...
      <div className="form-group">
            <label>How many performers are in the show</label>
              <input type="number" min="1" className="form-control" 
                     name="show_amount_people" value={this.state.show_amount_people} onChange={this.handleShowInput} required />         
                </div>
      ...
      <div className="form-group">
             <label >Do you need a dressing-room</label>
              <select className="form-control form-control" value={this.state.show_dressing_room} 
                                                      name="show_dressing_room" onChange={this.handleShowInput} required >
      ...
      <div className="form-group">
        ...
        <div className="form-check">
          <input className="form-check-input" type="checkbox" name="monday" value="Yes" onChange={this.handleShowInput}/>
            <label className="form-check-label">Monday</label>
              </div>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" name="tuesday" value="Yes" onChange={this.handleShowInput}/>
            <label className="form-check-label">Tuesday</label>
              </div>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" name="wednesday" value="Yes" onChange={this.handleShowInput}/>
            <label className="form-check-label">Wednesday</label>
              </div>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" name="thursday" value="Yes" onChange={this.handleShowInput}/>
            <label className="form-check-label">Thursday</label>
              </div>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" name="friday" value="Yes" onChange={this.handleShowInput}/>
            <label className="form-check-label">Friday</label>
               </div>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" name="saturday" value="Yes" onChange={this.handleShowInput}/>
            <label className="form-check-label">Saturday</label>
              </div>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" name="sunday" value="Yes" onChange={this.handleShowInput}/>
        ...
        <div className="form-check">
          <input className="form-check-input" type="checkbox" name="morning" value="Yes" onChange={this.handleShowInput}/>
            <label className="form-check-label">Morning</label>
              </div>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" name="late_morning" value="Yes" onChange={this.handleShowInput}/>
            <label className="form-check-label">Late Morning</label>
              </div>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" name="early_night" value="Yes" onChange={this.handleShowInput}/>
            <label className="form-check-label">Early Night</label>
              </div>
        <div className="form-check">
          <input className="form-check-input" type="checkbox" name="late_night" value="Yes" onChange={this.handleShowInput}/>
        ...
        <div className="form-group">
            <label>Website</label>
               <input type="text" className="form-control" name="show_url" value={this.state.show_url} 
                                 onChange={this.handleShowInput} placeholder="Website or other" />         
                </div>
