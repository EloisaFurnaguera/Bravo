        ...
        <form autoComplete="off" className="form2-up" onSubmit={this.handleUserUpdate}>
          ...
          <div className="form-group">
            <label>First Name</label>  
              <input type="fname" className="form-up" 
                                  onChange={this.handleUserUpdateInput} 
                                  name="fname" 
                                  placeholder= {this.props.user_fname} />                                    
          </div>
            <div className="form-group">
              <label>Last Name</label>        
                 <input type="lname" className="form-up" 
                        onChange={this.handleUserUpdateInput} 
                        name="lname"                                                    
                        placeholder={this.props.user_lname} />                             
            </div>

          <div className="form-group">
            <label>Email</label>              
              <input type="email" className="form-up" 
                                  onChange={this.handleUserUpdateInput} 
                                  name="email"                                                   
          ...
          <div className="form-group"> 
            <label>New Password</label>  
              <input type="password" className="form-up" 
                                     onChange={this.handleUserUpdateInput}
                                      name="password" 
