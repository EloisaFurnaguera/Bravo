class VenueUpdateForm extends React.Component {
  ...
  render(){
    return(
      ...
      <div className ="backgroud-uv">

        <div className="container-fluid venue-update">   
          <div className="d-flex flex-row-reverse bd-highlight">

            <div className="p-2 bd-highlight"> 
              <a className="top-letter-uv" href="#" onClick= {this.handleLogOut}>Log Out</a>
            </div>

            <div className="p-2 bd-highlight"> 
              <a className="top-letter-uv" href="#" onClick= {this.handleUserHome}>Home</a>
            </div>        
          </div>
        ...
        <form autoComplete="off" onSubmit= {this.handleVenueUpdate}>        
            ...
            <div className="form-group">
              <label >How much is the space per hour?</label>
                  <select className="form-control" value={this.state.venue_rent} 
                    ...
                    <option value="250">From $201 to $300</option>
          ...
          <div className="row justify-content-center">
            <button type="submit" className="btn btn-default button-letter-uv big-letter-Lato">Submit</button>
          </div>
