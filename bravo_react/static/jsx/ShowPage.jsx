  ...
  handleLogOut(e) {
                        ...
                        show_rent)
   {
    ...
    handleMatchPage(e , id, type) {
     ...
     handleMatchPage(e , id, user_fname, type="show") {
      e.preventDefault();
...
<div className="top-container-sp">
          ...
          <div className="top-links-container-sp">
                  ...
                  <div><a className="little-letter-M-White-sp" href="#" onClick= {this.handleLogOut}>Log Out</a>
                          ...
                          <div><a className="little-letter-M-White-sp" href="#" onClick= {(e) => this.handleShowUpdate( e, 
                                                                                                                        this.state.show_id,
                                                                                                                        this.state.type,
                                                                                                                        this.state.user_fname,
                        ...
                        <div><a className="little-letter-M-White-sp" href="#" onClick= {this.handleProducerPage}>Home</a>
                          </div>
